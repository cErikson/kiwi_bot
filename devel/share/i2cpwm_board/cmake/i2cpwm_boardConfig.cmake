...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/pi/mec_bot/src/ros-i2cpwmboard)
  set(i2cpwm_board_DEVEL_PREFIX /home/pi/mec_bot/devel)
  ...
  set(i2cpwm_board_INSTALL_PREFIX /home/pi/mec_bot/install)
...
if(NOT "/home/pi/mec_bot/devel/include " STREQUAL " ")
  set(i2cpwm_board_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/mec_bot/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/mec_bot/src/ros-i2cpwmboard/${idir}'.  ${_report}")
    endif()
